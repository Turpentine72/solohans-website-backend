...
router.post('/', async (req, res) => {
  try {
    ...
    const orderData = {
      ...
      totalAmount: itemsSubtotal, // delivery fee, if any, gets added later by admin
      delivery_fee: null,
      // Pickup never needs a delivery fee, so treat it as already "set"
      // so the customer can pay immediately.
      delivery_fee_set: delivery_method === 'pickup',
      status: 'Pending',
